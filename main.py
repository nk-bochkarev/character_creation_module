...
def attack(char_name, char_class):
    str_cons = 'нанёс урон противнику равный'
    if char_class == 'warrior':
        return (f'{char_name} {str_cons} {5 + randint(3, 5)}')
    if char_class == 'mage':
        return (f'{char_name} {str_cons} {5 + randint(5, 10)}')
    if char_class == 'healer':
        return (f'{char_name} {str_cons} {5 + randint(-3, -1)}')
...
def special(char_name, char_class):
    str_cons = 'применил специальное умение'
    if char_class == 'warrior':
        return (f'{char_name} {str_cons} «Выносливость {80 + 25}»')
    if char_class == 'mage':
        return (f'{char_name} {str_cons} «Атака {5 + 40}»')
    if char_class == 'healer':
        return (f'{char_name} {str_cons} «Защита {10 + 30}»')
